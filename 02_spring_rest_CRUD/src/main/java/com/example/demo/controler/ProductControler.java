...
public class ProductControler {
	...
	Optional<Product> findByProductId(@PathVariable int id) {
		//System.out.println("colectinggggggggggggggggggggggggggggggggggggg"+id);
	...
	@GetMapping("/products/req/{id}")
	Optional<Product> findByProductIdUsingRequest(@RequestParam String id) {
		//System.out.println("colectinggggggggggggggggggggggggggggggggggggg"+id);
