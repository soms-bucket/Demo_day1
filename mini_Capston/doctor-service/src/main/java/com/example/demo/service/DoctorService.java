...
public class DoctorService implements IDoctorService{
	...
	@Override
	public Doctor createDoctor(@Valid Doctor newProduct) {
		// TODO Auto-generated method stub
		return productRepo.save(newProduct);
	}

	@Override
	public ResponseEntity<Doctor> updateDoctor(Integer productId, @Valid Doctor newProduct) {
		Optional<Doctor> existingProduct = productRepo.findById(productId);
		existingProduct.get().setDocName(newProduct.getDocName());
