...
public class PatientController {
	...
	@PostMapping("/patient")
	public Patient createPatient(@Valid @RequestBody Patient newProduct) {
		return patientService.createPatient(newProduct);
	}

	@PutMapping("/patient/{id}")
	public ResponseEntity<Patient> updatePatient
	(@PathVariable(value = "id") Integer productId,@Valid @RequestBody Patient newProduct) {
		return patientService.updatePatient(productId,newProduct);
	}
